  ...
  render() {
    ...
    return (
      <div className="wrapper">
        {/* Stock BarchartChart */}
        <div className="box Stock-Available">
        ...
        {/* Products Barchart */}
        <div className="box Products-Available">
          ...
          <BarChart
            ...
            <Bar dataKey="Snck" stackId="b" fill="#00C49F" />
            <Bar dataKey="Refridg" stackId="b" fill="#0088FE" />
          </BarChart>
        </div>

        {/* Piechart */}
        <div className="box Available-Products-percentage">
        ...
        <div className="box sales">
          ...
          <BarChart
            ...
            <YAxis />
            <Tooltip />
            <Legend verticalAlign="left" height={30} />
